...
.topic_bus{
  ...
  <body>
        ...
        <div class="about-intro">
            ...
            <p>We, TravelonWheels (Pvt) Ltd. who is pioneer of Online Bus Ticket Booking Service in Maharashtra since (2019). In this segment the company has launch a web site www.travelonwheels.in with the collaboration of registered Busses of Maharashtra State.</p>
        </div>
    </div>
...
?>
        ...
        <div class="about-intro">
            ...
            <p>Plan your journey ahead of time, save time buying bus tickets, avoid lengthy lines, discover your boarding location quickly, and enjoy your joyous journey in comfort using "TravelonWheels" efficient bus reservation system
            </p>
